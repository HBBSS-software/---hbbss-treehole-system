...
export default function Friends({ user }) {
  ...
  function handleAccept(requestId) {
    setActionLoading(function(prev) { return Object.assign({}, prev, {[requestId]: true}); });
    axios.post('/api/friends/accept/' + requestId, {}, { headers: headers })
      ...
      .finally(function() { setActionLoading(function(prev) { return Object.assign({}, prev, {[requestId]: false}); }); });
  }
  ...
  function handleRemoveFriend(friendId) {
    ...
    setActionLoading(function(prev) { return Object.assign({}, prev, {[friendId]: true}); });
    axios.delete('/api/friends/' + friendId, { headers: headers })
      ...
      .finally(function() { setActionLoading(function(prev) { return Object.assign({}, prev, {[friendId]: false}); }); });
  }
  ...
  function handleSendRequest(userId) {
    setActionLoading(function(prev) { return Object.assign({}, prev, {[userId]: true}); });
    axios.post('/api/friends/request/' + userId, {}, { headers: headers })
      ...
      .finally(function() { setActionLoading(function(prev) { return Object.assign({}, prev, {[userId]: false}); }); });
  }
